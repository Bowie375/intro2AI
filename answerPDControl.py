...
def calc_pd_force(target_pos, current_pos, current_vel, kp, kd):
    ...
    ### 你的代码 ###
    #pdb.set_trace()
    #p_force_length=np.linalg.norm(target_pos-current_pos)
    p_force=(target_pos-current_pos)
    #p_force=p_force/p_force_length
    p_force=p_force*kp

    d_force=current_vel*kd
    force=p_force-d_force
    ### 你的代码 ###
    return force